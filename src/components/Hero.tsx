export default function Hero() {
    return <div className="flex items-center justify-center h-[90vh] w-full relative bg-cover hero-bg">
        ...
        <div className="flex flex-col font-semibold text-white z-10 items-center gap-y-2">
            ...
            <span className="">Selesaikan Tugas IT Anda Sambil Belajar</span>
