export default function Invitation() {
    return <div id="how-to-order" className="bg-base-100 py-10 mt-10">
        <div className="container p-10 mx-auto">
            ...
            <div className="grid grid-cols-3 gap-y-4 gap-x-9 mt-5">
                <div className="card card-border bg-base-100 shadow-lg shadow-base-200 col-start-2">
                    <div className="card-body">
            ...
            <div className="grid grid-cols-3 gap-y-4 gap-x-9 mt-5">
                <div className="card card-border bg-base-100 shadow-lg shadow-base-200 col-start-3">
                    <div className="card-body">
